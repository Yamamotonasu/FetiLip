...
SWIFT_CLASS("_TtC13FloatingPanel4Core")
@interface Core : NSObject <UIGestureRecognizerDelegate>
...
SWIFT_PROTOCOL("_TtP13FloatingPanel28FloatingPanelLayoutAnchoring_")
...
SWIFT_CLASS("_TtC13FloatingPanel33FloatingPanelAdaptiveLayoutAnchor")
...
@interface FloatingPanelAdaptiveLayoutAnchor (SWIFT_EXTENSION(FloatingPanel))
...
SWIFT_PROTOCOL("_TtP13FloatingPanel21FloatingPanelBehavior_")
...
SWIFT_PROTOCOL("_TtP13FloatingPanel19FloatingPanelLayout_")
...
SWIFT_CLASS("_TtC13FloatingPanel25FloatingPanelBottomLayout")
...
SWIFT_PROTOCOL("_TtP13FloatingPanel31FloatingPanelControllerDelegate_")
@protocol FloatingPanelControllerDelegate
@optional
...
SWIFT_CLASS("_TtC13FloatingPanel34FloatingPanelIntrinsicLayoutAnchor")
...
@interface FloatingPanelIntrinsicLayoutAnchor (SWIFT_EXTENSION(FloatingPanel))
- (NSArray<NSLayoutConstraint *> * _Nonnull)layoutConstraints:(FloatingPanelController * _Nonnull)vc for:(enum FloatingPanelPosition)position SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC13FloatingPanel25FloatingPanelLayoutAnchor")
...
@property (nonatomic, readonly) enum FloatingPanelLayoutReferenceGuide referenceGuide;
@property (nonatomic, readonly) enum FloatingPanelReferenceEdge referenceEdge;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface FloatingPanelLayoutAnchor (SWIFT_EXTENSION(FloatingPanel))
- (NSArray<NSLayoutConstraint *> * _Nonnull)layoutConstraints:(FloatingPanelController * _Nonnull)vc for:(enum FloatingPanelPosition)position SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC13FloatingPanel18FloatingPanelState")
...
SWIFT_CLASS("_TtC13FloatingPanel22ModalDismissTransition")
...
SWIFT_CLASS("_TtC13FloatingPanel22ModalPresentTransition")
...
SWIFT_CLASS("_TtC13FloatingPanel15ModalTransition")
...
SWIFT_CLASS_NAMED("PassthroughView")
...
SWIFT_CLASS("_TtC13FloatingPanel22PresentationController")
...
@property (nonatomic, readonly) CGRect grabberAreaFrame;
...
- (void)setWithContentView:(UIView * _Nonnull)contentView;
- (BOOL)hasStackView SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface UIViewController (SWIFT_EXTENSION(FloatingPanel))
@property (nonatomic, readonly) UIEdgeInsets fp_safeAreaInsets;
@end
